...
test("positive controls: /editor/lib/paths.js and /editor/client/draft.js are 200; page HTML still carries the token and all eight script tags", async () => {
  const fixture = buildFixture({ withClient: true });
  let srv;
  try {
